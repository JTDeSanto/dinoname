class Dinoname 
  ...
  def generate_name
    if self.name.present?
      ...
      if /[aeiouy]/ =~ @first_name.last  && /[aeiou]/ =~ @last_name[0]
  ...
  def suffix
    endings = ["saurus","ceratops","dactyl","adon", "sauralophus","opteryx", "lophodon", "saurus rex", "cephalasaurus", "agnathus", "onychus", "olestes", "thiomimus", "spondylus", "dromeus" ]
